...
class JacquesMod(loader.Module):
	...
	strings = {
		'name': 'Пейнизатор',
		'usage': 'Напиши <code>.pain Пейнизатор</code>',
	}
	def __init__(self):
	...
	async def paincmd(self, message):
		""".pain <реплай на сообщение/свой текст>"""
		...
		await message.edit("<b>Sekaini itami o...</b>")
		pic = requests.get("https://i.ibb.co/4YwCtnM/Pain.png")
